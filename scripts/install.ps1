...
if ($action -eq "3") {
    Write-Host ""
    Write-Host "  Uninstalling Agent Guidance MCP..." -ForegroundColor Red
    Write-Host ""
    ...
    if (Get-Command "uv" -ErrorAction SilentlyContinue) {
        ...
        Write-Host "  v Uninstalled from uv" -ForegroundColor Green
    ...
    Write-Host "|       v  Uninstallation complete!                            |" -ForegroundColor Green
    Write-Host "+--------------------------------------------------------------+" -ForegroundColor Green
    Write-Host ""
    exit 0
}
...
if (Get-Command "uv" -ErrorAction SilentlyContinue) {
    $uvBin = "uv"
    Write-Host "  v Found 'uv' in PATH" -ForegroundColor Green
} else {
    $defaultUvPath = "$HOME\.local\bin\uv.exe"
    if (Test-Path $defaultUvPath) {
        $uvBin = $defaultUvPath
        Write-Host "  v Found 'uv' at $uvBin" -ForegroundColor Green
    } else {
        ...
        Write-Host "  v uv installed" -ForegroundColor Green
    }
}
...
Write-Host ""
Write-Host "Step 3/3 - Configuring IDE clients..." -ForegroundColor White
$modeFlag = ""
...
Write-Host ""
Write-Host "+--------------------------------------------------------------+" -ForegroundColor Green
Write-Host "|         v  Installation completed successfully!               |" -ForegroundColor Green
Write-Host "+--------------------------------------------------------------+" -ForegroundColor Green
Write-Host ""
