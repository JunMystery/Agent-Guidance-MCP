 ...
 *
 * For full color extraction from images, integrate with image-generation tooling skill
 ...
 *
 * Integration:
 *   For image color analysis, use: image-generation tooling skill or ImageMagick
...
function main() {
  ...
  const result = {
    ...
    instructions: [
      ...
      "",
      "2. Or use available image-analysis tooling:",
      `   python path/to/image-analysis-script.py \\`,
      `     --files "${resolvedPath}" \\`,
      `     --task analyze \\`,
