...
python skills/ui-ux-pro-max/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python skills/ui-ux-pro-max/scripts/search-slides.py "series a funding" -d strategy --json
```
