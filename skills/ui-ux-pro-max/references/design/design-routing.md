...
**Brand:**
```bash
node skills/ui-ux-pro-max/scripts/brand/inject-brand-context.cjs
node skills/ui-ux-pro-max/scripts/brand/validate-asset.cjs <path>
```

**Tokens:**
```bash
node skills/ui-ux-pro-max/scripts/generate-tokens.cjs -c tokens.json
node skills/ui-ux-pro-max/scripts/validate-tokens.cjs -d src/
```
